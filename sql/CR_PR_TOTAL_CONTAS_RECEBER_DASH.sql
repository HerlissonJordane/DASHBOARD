IF EXISTS(SELECT COUNT(*) FROM SYS.OBJECTS  WHERE TYPE = 'P' AND NAME = 'PR_TOTAL_CONTAS_RECEBER_DASH')
DROP PROCEDURE PR_TOTAL_CONTAS_RECEBER_DASH
GO
CREATE PROCEDURE PR_TOTAL_CONTAS_RECEBER_DASH
@DATA_INI DATE,
@DATA_FIM DATE,
@LOJA INT,
